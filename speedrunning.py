...
def answer_checker(question,answer,score):
  guess = guess_validator(question) #Calls the guess_validator function to ensure an invalid value is not treated as an incorrect answer
